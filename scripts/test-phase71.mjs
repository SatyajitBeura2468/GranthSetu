...
try {
  ...
  const futureEnrollment = await client.rpc("member_set_enrollment_v71", { p_member_id: runtimeStudent.data, p_academic_session_id: futureSession.data.id, p_grade_level_id: grade.data.id, p_section_id: section.data.id, p_roll_number: `FUTURE-${token}`, p_status: "active" });
