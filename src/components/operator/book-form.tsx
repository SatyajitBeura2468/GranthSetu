...
type Book = { id?: string; title?: string; subtitle?: string; isbn?: string; edition?: string; publication_year?: number; language_code?: string; description?: string; updated_at?: string; category_ids?: string[] };

export function BookForm({ libraryCode, book, author, categories, disabled = false, submitLabel = "Save book" }: {
